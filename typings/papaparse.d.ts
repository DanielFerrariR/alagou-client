...
declare module 'papaparse' {
  ...
  export type GuessableDelimiters =
    | ','
    | '\t'
    | '|'
    | ';'
  ...
  export interface ParseConfig<T = any> {
    ...
    complete?(results: ParseResult<T>, file?: any): void // default: undefined
    error?(error: ParseError, file?: any): void // default: undefined
